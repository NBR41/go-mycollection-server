...
CREATE TABLE `users` (
    ...
    `email` VARCHAR(255) COLLATE UTF8_UNICODE_CS NOT NULL DEFAULT '',
    `nickname` VARCHAR(32) COLLATE UTF8_UNICODE_CS NOT NULL DEFAULT '',
...
CREATE TABLE `ownerships` (
    ...
    `book_id` VARCHAR(255) COLLATE UTF8_UNICODE_CS NOT NULL DEFAULT '',
    `create_ts` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00',
    `update_ts` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
